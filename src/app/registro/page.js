        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
          {exito ? (
            <div className="text-center py-4">
              ...
              <p className="text-zinc-400 text-sm mb-6">Ya puedes iniciar sesión con tus credenciales</p>
              <a href="/login" className="block w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-semibold transition text-center">
                Ir al login
              </a>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={cargando} className="w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed">
