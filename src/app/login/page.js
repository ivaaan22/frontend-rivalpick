      ...
      <div className="hidden lg:flex lg:w-1/2 bg-emerald-500 flex-col justify-between p-12">
        ...
        <div>
          <h2 className="text-4xl font-bold text-black mb-4 leading-tight">
            Predice. Compite.<br />Gana con amigos.
          </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition"
                  required
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                disabled={cargando}
                className="w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <p className="mt-6 text-center text-sm text-zinc-500">
              ¿No tienes cuenta?{' '}
              <a href="/registro" className="text-emerald-400 hover:text-emerald-300 font-medium transition">
                Crea una gratis
              </a>
            </p>
          </div>
