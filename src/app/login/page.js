      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
            ...
            <p className="mt-2 text-center text-sm text-zinc-600">¿Olvidaste tu contraseña?{' '}<a href="/recuperar-password" className="text-zinc-400 hover:text-zinc-300 transition">Recúperala aquí</a></p>
          </div>
        </div>
      </div>
    </div>
